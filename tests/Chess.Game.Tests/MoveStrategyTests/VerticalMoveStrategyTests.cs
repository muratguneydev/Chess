	...
	private class VerticalMoveStrategyDataCollection
	{
		public static IEnumerable TestCases
		{
			get
			{
				...
				yield return new MoveStrategyTestData(new FromTo(new Cell(new Coordinate(5, 2)), new Cell(new Coordinate(5, 4))))
					.SetName("Move up from row 2 column 5 to row 4 column 5")
					.Returns(new[] {
						new Coordinate(5, 3)
					});
				yield return new MoveStrategyTestData(new FromTo(new Cell(new Coordinate(7, 2)), new Cell(new Coordinate(7, 6))))
					.SetName("Move up from row 2 column 7 to row 6 column 7")
					.Returns(new[] {
						new Coordinate(7, 3), new Coordinate(7, 4), new Coordinate(7, 5)
					});
				yield return new MoveStrategyTestData(new FromTo(new Cell(new Coordinate(5, 4)), new Cell(new Coordinate(5, 7))))
				...
				yield return new MoveStrategyTestData(new FromTo(new Cell(new Coordinate(1, 0)), new Cell(new Coordinate(0, 0))))
					...
					.Returns(Enumerable.Empty<Coordinate>());
				yield return new MoveStrategyTestData(new FromTo(new Cell(new Coordinate(4, 7)), new Cell(new Coordinate(4, 5))))
					.SetName("Move down from row 7 column 4 to row 5 column 4")
					.Returns(new[] {
						new Coordinate(4, 6)
					});
				yield return new MoveStrategyTestData(new FromTo(new Cell(new Coordinate(7, 6)), new Cell(new Coordinate(7, 2))))
					.SetName("Move down from row 6 column 7 to row 2 column 7")
					.Returns(new[] {
						new Coordinate(7, 3), new Coordinate(7, 4), new Coordinate(7, 5)
					});
				yield return new MoveStrategyTestData(new FromTo(new Cell(new Coordinate(4, 3)), new Cell(new Coordinate(4, 0))))
