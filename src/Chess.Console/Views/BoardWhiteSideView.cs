...
public class BoardWhiteSideView : View
{
	private readonly WhiteSideBoardRowCollection boardRows;
	private readonly ConsoleWriterFactory consoleWriterFactory;

	public BoardWhiteSideView(WhiteSideBoardRowCollection boardRows, ConsoleWriterFactory consoleWriterFactory)
	{
	...
	private void WriteHeaderRow()
	{
		this.consoleWriterFactory
			...
			.WriteLineWithSeparatorPrefix(new[] { "a", "b", "c", "d", "e", "f", "g", "h" });
	}
